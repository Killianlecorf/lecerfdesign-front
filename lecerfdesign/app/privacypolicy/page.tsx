            ...
            <Header/>
                ...
                <div className="privacyPoliceMentionContent">
                    <div className="privacyPoliceContent">
                        ...
                        <p style={{marginBottom: "20px"}}>La présente Politique de confidentialité décrit la façon dont vos informations personnelles sont recueillies, utilisées et partagées lorsque vous vous rendez sur https://lecerfdesign.com/ ou que vous y effectuez une demande de contact.</p>
